                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    foreach ($_SESSION['basket'] as $tmp) {
                                        echo "<tr>
                                            <td class='product-thumbnail'><a href='product-details.php?id={$tmp['id']}'><img src='images/tovar/{$tmp['photo']}' alt='product img' /></a></td>
                                            <td class='product-name'><a href='product-details.php?id={$tmp['id']}'>{$tmp['model']}</a></td>
                                            <td class='product-price'><span class='amount'>£{$tmp['price']}</span></td>
                                            <td class='product-quantity'><input type='number' min='1' value='{$tmp['count']}' /></td>
                                            <td class='product-subtotal'>£165.00</td>
                                            <td class='product-remove'><a href='basket.php?id={$tmp['id']}&mode=del'>X</a></td>
                                        </tr>";
                                    }
                                    ?>
