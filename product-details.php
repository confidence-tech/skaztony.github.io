                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">ІНФОРМАЦІЯ ПРО ТОВАР<br><strong style="color: #cd0a0a">STS GEAR</strong></h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.php">Головна</a>
                                  <span class="brd-separetor">/</span>
                                  <span class="breadcrumb-item active">Інформація про продукт</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-5 col-xs-12">
                            ...
                            <?php
                                if (isset($_GET['id']) && !empty($_GET['id'])) {
                                    $querySelectPhoto = "SELECT id, main, name_photo FROM photo WHERE id_tovar=" . $_GET['id']." ORDER BY main DESC";
                                    $resSelctPhoto = mysqli_query($dbc, $querySelectPhoto) or die('Query photo error');

                                    while ($nextPhoto = mysqli_fetch_array($resSelctPhoto)) {
                                        echo '<div class="scroll-single-product mb--30">
                                                <img src="/images/tovar/'.$nextPhoto['name_photo'].'" alt="full-image">
                                            </div>';
                                    }

                                    $query = "SELECT id, model, price, material, short_description, fulldescription, haract, id_type, index_tovar, colichestvo, id_podtype, popularity, oldprice, size, style FROM assort WHERE id=".$_GET['id'];
                                    $res = mysqli_query($dbc, $query) or die('Query Error Error');
                        ...
                        <div class="sidebar-active col-md-5 col-lg-5 col-sm-7 col-xs-12 xmt-30">
                            <div class="htc__product__details__inner ">
                                ...
                                <div class="pro__details">
                                    <p><?=$next['short_description']?></p>
                                </div>
                                <ul class="pro__dtl__prize">
                                    <?php
                                        if ($next['oldprice'] != null){
                                            echo '<li class="old__prize">'.$next['oldprice'].'</li>';
                                        }
                                    ?>
                                    <li><?=$next['price']?></li>
                                </ul>
...
<!--                                </div>-->
                                ...
                                <ul class="pro__dtl__btn">
                                    <li class="buy__now__btn"><a href="basket.php?id=<?=$_GET['id']?>&mode=add">Купить</a></li>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="product__details">
                                                        ...
                                                        <ul class="product__price">
                                                            <li class="old__price">$14.00</li>
                                                            <li class="new__price">$11.00</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    ...
                                                    <div class="product__details">
                                                        <h2><a href="product-details.html">Simple Black Clock</a></h2>
                                                        <ul class="product__price">
                                                            <li class="old__price">$555.00</li>
                                                            <li class="new__price">$6658.00</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
